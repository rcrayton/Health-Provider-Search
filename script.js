...
function getDrList(){
    ...
    fetch(`https://npiregistry.cms.hhs.gov/api/?version=2.1&taxonomy_description=${searchInputTxt}`)
...
//             data.doctors.forEach(meal => {
//                 html += `
//                     <div class = "doctor-item" data-id = "${results.first_name}">
//                         <div class = "dr-img">
//                             <img src = "${meal.strMealThumb}" alt = "Doctor">
//                         </div>
//                         <div class = "doctor-name">
//                             <h3>${meal.strMeal}</h3>
//                             <a href = "#" class = "dr-btn">Get Recipe</a>
//                         </div>
//                     </div>
//                 `;
//             });
